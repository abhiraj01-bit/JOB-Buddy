                        ...
                        <div className="rounded-xl border border-border bg-card p-4">
                            ...
                            <div className="mt-2 flex gap-1">
                                {[1, 2, 3].map((l) => (
                                    <div
                                        key={l}
                                        className={`h-1.5 flex-1 rounded-full ${l <= (questions[currentQ]?.difficulty === "easy" ? 1 : questions[currentQ]?.difficulty === "hard" ? 3 : 2)
                                                ? "bg-primary"
                                                : "bg-secondary"
                                            }`}
                                    />
                        ...
                        <div className="max-h-52 overflow-y-auto p-4 space-y-3">
                            {transcript.map((t, i) => (
                                <div key={i} className={`flex gap-2 ${t.role === "candidate" ? "justify-end" : ""}`}>
                                    <div className={`max-w-[85%] rounded-lg px-3 py-2 text-xs leading-relaxed ${t.role === "ai" ? "bg-secondary text-secondary-foreground" : "bg-primary text-primary-foreground"
                                        }`}>
                                        {t.text}
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {questions.map((_, i) => (
                                <button
                                    ...
                                    className={`flex h-8 w-8 items-center justify-center rounded-lg text-xs font-medium transition-colors ${i === currentQ
