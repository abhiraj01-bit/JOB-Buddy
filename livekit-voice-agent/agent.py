...
from livekit.plugins import noise_cancellation, silero, google, anam
# Removed turn detector import to prevent initialization crash

load_dotenv(".env.local")

class ProctorAgent(Agent):
    def __init__(self, session: AgentSession, llm_instance: google.LLM) -> None:
        super().__init__(
