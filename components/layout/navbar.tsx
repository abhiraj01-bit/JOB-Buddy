      ...
      <div className="flex-1 flex items-center justify-center max-w-md mx-auto">
        {searchOpen ? (
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 rounded-lg bg-secondary px-3 py-1.5 text-sm text-muted-foreground hover:bg-accent/10 transition-colors w-full max-w-sm"
          >
